                                                        ...
                                                        <table cellpadding="0" cellspacing="0" width="100%"
                                                            ...
                                                            <tr>
                                                                <td align="center"
                                                                    ...
                                                                    <img src="{{ $message->embed(public_path('/images/mails/logo_welcome.png')) }}"
                                                                        alt
                                                            ...
                                                            <tr>
                                                                <td align="left"
                                                                    ...
                                                                    <p
                                                                        ...
                                                                        Ciao, {{ $user->firstname }}!<br>Benvenuto nel
                                                                        Top One Diving.<br>Di seguito troverai le
                                                                        credenziali per accedere al nostro portale, dove
                                                                        potrai seguire le tue attività presso la nostra
                                                                        scuola in tempo reale.<br>Al primo accesso, ti
                                                                        consigliamo di&nbsp;cambiare la tua
                                                                        password.<br></p>
                                                                </td>
                                                            </tr>
                                                        </table>
