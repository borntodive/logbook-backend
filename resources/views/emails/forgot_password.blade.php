                                                        ...
                                                        <table cellpadding="0" cellspacing="0" width="100%"
                                                            ...
                                                            <tr>
                                                                <td align="center"
                                                                    ...
                                                                    <img src="{{ $message->embed(public_path('/images/mails/logo_password_reset.png')) }}"
                                                                        alt
                                                            ...
                                                            <tr>
                                                                <td align="left"
                                                                    ...
                                                                    <p
                                                                        ...
                                                                        Ciao, {{ $user->firstname }}!<br>Di seguito
                                                                        troverai la tua nuova password per accedere al
                                                                        nostro portale.<br>Al primo accesso, ti
